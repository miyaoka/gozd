...
<template>
  <button
    v-if="link"
    type="button"
    class="flex shrink-0 items-center gap-1 rounded-full bg-warning-subtle px-2 py-0.5 text-[10px] font-medium text-warning-text transition-colors hover:bg-warning-subtle"
