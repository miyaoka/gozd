...
// 素の setTimeout ではなく useTimeoutFn: unmount (shown 前に dock back 等で閉じた) 後も
// 生き残ったタイマーが、その間にユーザーが開き直した別 popover を誤って閉じるのを防ぐ
// (effect scope 破棄で自動停止)
useTimeoutFn(closeSourcePopover, UNDOCK_CLOSE_FALLBACK_MS);
