...
<template>
  <div class="flex flex-col gap-1">
    <template v-if="voicevoxStore.speakers.length > 0">
      ...
      >
        ...
        <div class="flex-1">
          ...
          <button
            type="button"
            class="ml-1 underline hover:text-warning-strong"
      ...
      <div class="flex items-center gap-2 text-xs text-foreground-subtle">
        ...
        <select
          ...
          class="min-w-0 flex-1 rounded-sm bg-surface-1 px-1 py-0.5 text-foreground"
      ...
      <div class="flex items-center gap-2 text-xs text-foreground-subtle">
        ...
        <select
          ...
          class="min-w-0 flex-1 rounded-sm bg-surface-1 px-1 py-0.5 text-foreground disabled:opacity-50"
    ...
    <div v-else class="text-xs text-foreground-subtle italic">
      Enable VOICEVOX to load characters
    </div>
  </div>
</template>
