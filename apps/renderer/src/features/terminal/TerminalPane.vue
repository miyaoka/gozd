...
配置そのものの規約は [docs/terminal.md](../../../../../docs/terminal.md) が SSOT。

**端末に焦点があるかどうかを判定するのはこの面**。端末宛のキー割り当ての条件に使われるため、
実際の焦点位置とずれるとキーが黙って外れる。判定結果を自分で保持せず、そのつど実際の焦点位置
から逆引きするのは、焦点の移動が必ずしもこの面を経由しないため。
</doc>
