...
| `gitStatusChange`  | `index` / working tree / HEAD / `refs/remotes/*` の変更 | useGitStatusSync (全 worktree の ahead/behind 反映)、FilerPane / GitGraphPane (active の HEAD / branchHead / upstream 変化で `loadLog`)            |
