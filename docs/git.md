...
| `worktreeChange`   | `worktrees/*` 配下、main worktree 自身の `HEAD` (branch 切替)                                                                    | useSidebarData (source dir の repo)                                                                                                                |
