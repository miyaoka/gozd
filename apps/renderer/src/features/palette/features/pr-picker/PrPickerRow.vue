...
<template>
  <span class="truncate text-success">#{{ pr.number }}</span>
  <span class="truncate">{{ pr.title }}</span>
  <span class="truncate text-info">{{ pr.headRef }}</span>
  <span class="flex items-center gap-1 truncate text-foreground-muted">
    <img
