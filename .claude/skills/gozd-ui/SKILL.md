...
| modal active tab / palette selected item (background) | (neutral) | accent system                                            | SettingsModal active tab / palette dialog selected item (`bg-accent-strong text-foreground-strong`) |
