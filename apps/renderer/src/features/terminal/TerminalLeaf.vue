  ...
  <div class="min-h-0 min-w-0" :data-leaf-id="leafId">
    ...
    >
      ...
      <div
        ...
        :style="{ backgroundColor: currentTheme.background }"
        :class="isInsideWorktree ? 'text-foreground-muted' : 'text-destructive'"
        :title="cwd"
      >
      ...
      <div
        ...
        :style="{ backgroundColor: currentTheme.background }"
        :class="{
          'text-foreground-subtle': claudeState === 'idle',
          'text-warning': claudeState === 'working',
          'text-warning-strong': claudeState === 'asking',
          'text-success': claudeState === 'done',
        }"
      >
        <span
          class="size-3.5"
