  ...
  >
    <div class="group/wt relative">
      <div
        ...
        class="flex w-full cursor-pointer items-center gap-2 rounded-lg px-2 py-1 text-foreground-low transition-colors hover:bg-element-hover focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-hidden focus-visible:ring-inset"
        @click="onHeaderClick"
